...
const JobCategory = () => {
    return (
        <div className='my-14 md:my-32'>
            <h1 className='text-2xl md:text-5xl font-extrabold text-center'>Job Category List</h1>
            <p className='text-center text-gray-400 my-4 px-10 md:px-0'>Explore thousands of job opportunities with all the information you need. Its your future</p>
